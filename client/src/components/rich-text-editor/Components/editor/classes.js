...
export const editorClasses = {
  ...
  content: {
    ...
    table: createClasses('editor__content__table'),
    tableRow: createClasses('editor__content__table__row'),
    tableCell: createClasses('editor__content__table__cell'),
    tableHeader: createClasses('editor__content__table__header'),
    customField: createClasses('editor__content__custom__field'),
  },
};
