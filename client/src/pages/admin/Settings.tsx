...
const ALL_TABS = [
  { id: 'activity-log', label: 'Activity Log', icon: BarChart3, heading: 'Activity Log', description: 'View activity logs, reports, and analytics.' },
  { id: 'users', label: 'Users', icon: Users, heading: 'Users', description: 'Manage registered users and their accounts.' },
  { id: 'team-members', label: 'Team Members', icon: Users, heading: 'Team Members', description: 'Manage team members and their access levels.' },
];
